...
* **Wearing wraps probably helps with lifting more**
  * People who wear wraps do better on squats, benches, and deadlifts than do people who don't (p<0.01). Since this data is not from an experiment, drawing causality is impossible. What we can say is that there is a correlation between wearing wraps and performing better. Practically speaking, wearing wraps likely only helps.
